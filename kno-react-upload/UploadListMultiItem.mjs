...
import { classNames as v, IconWrap as F } from "@progress/kno-react-common";
import { ProgressBar as N } from "@progress/kno-react-progressbars";
import r from "./utils/utils.mjs";
import { provideLocalizationService as m, registerForLocalization as S } from "@progress/kno-react-intl";
...
import { copyIcon as M } from "@progress/kno-svg-icons";
class z extends a.Component {
  ...
  render() {
    const { files: e, ...s } = this.props, [, t, i, d] = r.getFileStatus(e), l = m(this), f = l.toLanguageString(c, o[c]), E = l.toLanguageString(p, o[p]), h = l.toLanguageString(
      g,
      o[g]
    ), k = l.toLanguageString(u, o[u]), n = this.progress();
