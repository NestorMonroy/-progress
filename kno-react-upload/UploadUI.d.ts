 ...
 * @hidden
 */
export declare class UploadUIClassComponent extends React.Component<UploadUIProps, {}> {
...
export declare const UploadUI: React.ForwardRefExoticComponent<UploadUIProps & React.RefAttributes<any>>;
