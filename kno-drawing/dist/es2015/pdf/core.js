        ...
        if (!size && blob && /^image\/jpe?g$/i.test(blob.type)) {
            ...
            reader.onload = function() {
                try {
                    ...
                    // https://github.com/tlk/kno-ui-core/issues/4184).  If that's the case,
...
class PDFDocument {
    constructor (options) {
        ...
        var info = self.attach(new PDFDictionary({
            Producer     : new PDFString(getOption("producer", "Kno UI PDF Generator"), true), // XXX: kno.version?
            ...
            Creator      : new PDFString(getOption("creator", "Kno UI PDF Generator"), true),
...
class PDFJpegImage {
    constructor(data) {
        ...
        // through the canvas.
        // https://github.com/tlk/kno-ui-core/issues/2845
        data.offset(0);
