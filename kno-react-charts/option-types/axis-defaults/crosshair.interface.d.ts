...
export interface AxisDefaultsCrosshair {
    ...
    width?: number;
    /**
     * The options of the crosshair tooltip. The crosshair tooltip is displayed when the [`axisDefaults.crosshair.tooltip.visible`](components/charts/api/chartaxisdefaultscrosshairtooltipprops#toc-visible) option is set to `true`.
     */
