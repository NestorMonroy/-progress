...
export interface YAxisLabels {
    ...
    culture?: string;
    /**
     * The format for displaying the labels when the X values are dates. Uses the [`format`](components/intl/api/intlservice#toc-format) method of IntlService. Contains one placeholder (`"{0}"`) which represents the category value. The Chart selects the appropriate format for the current [`yAxis.baseUnit`](components/charts/api/chartyaxisitemprops#toc-baseunit). Setting the [`categoryAxis.labels.format`](components/charts/api/chartcategoryaxislabelsprops#toc-format) option overrides the date formats.
     */
