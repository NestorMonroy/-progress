...
export interface YAxisCrosshair {
    ...
    width?: number;
    /**
     * The options of the crosshair tooltip. The crosshair tooltip is displayed when the [`yAxis.crosshair.tooltip.visible`](components/charts/api/chartyaxiscrosshairtooltipprops#toc-visible) option is set to `true`.
     */
