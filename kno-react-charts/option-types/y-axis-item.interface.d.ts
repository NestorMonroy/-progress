...
export interface YAxis {
    ...
    /**
     * The interval between major divisions. If this is a date axis, the value represents the number of [`yAxis.baseUnits`](components/charts/api/chartyaxisitemprops#toc-baseunit) between major divisions. If the [`yAxis.type`](components/charts/api/chartyaxisitemprops#toc-type) is set to `"log"`, the `majorUnit` value is used for the base of the logarithm.
     */
    majorUnit?: number;
    /**
    ...
    /**
     * The interval between minor divisions. It defaults to one-fifth (1/5) of [`yAxis.majorUnit`](components/charts/api/chartyaxisitemprops#toc-majorunit). If [`yAxis.type`](components/charts/api/chartyaxisitemprops#toc-type) is set to `"log"`, the `minorUnit` value represents the number of divisions between two major units and defaults to the major unit minus one.
     */
    minorUnit?: number;
    /**
     * The unique axis name. Used to associate a series with a Y axis by using the [`series.yAxis`](components/charts/api/chartseriesitemprops#toc-yaxis) option.
     */
    name?: string;
    /**
    ...
    visible?: boolean;
    /**
     * The configuration options of the crosshair. The crosshair is displayed when the [`yAxis.crosshair.visible`](components/charts/api/chartyaxiscrosshairprops#toc-visible) option is set to `true`.
     */
    ...
    notes?: YAxisNotes;
    /**
     * The title configuration of the Scatter Chart Y axis. To display the title, set the [`yAxis.title.text`](components/charts/api/chartyaxistitleprops#toc-text) option.
     */
    title?: YAxisTitle;
}
