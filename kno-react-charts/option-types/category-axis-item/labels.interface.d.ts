...
export interface CategoryAxisLabels {
    ...
    /**
     * The culture to use when formatting date values. The specified culture must be loaded as demonstrated in the [Internationalization Overview](components/intl/i18n).
     */
    culture?: string;
    /**
     * The format for displaying the labels of the date category axis. The `{0}` placeholder represents the category value. The Chart selects the appropriate format for the current [`categoryAxis.baseUnit`](components/charts/api/chartcategoryaxisitemprops#toc-baseunit) option.
     *
     * Setting the [`categoryAxis.labels.format`](components/charts/api/chartcategoryaxislabelsprops#toc-format) option overrides the date formats. For more information, refer to the [`format`](components/intl/api/intlservice#toc-format) method of IntlService.
     *
     * > Not supported for Radar Charts. Use [`categoryAxis.labels.format`](components/charts/api/chartcategoryaxislabelsprops#toc-format) instead.
     */
    ...
    font?: string;
    /**
     * The format for displaying the labels. Uses the [`format`](components/intl/api/intlservice#toc-format) method of IntlService. Contains one placeholder (`"{0}"`) which represents the category value.
     */
    format?: string;
    /**
