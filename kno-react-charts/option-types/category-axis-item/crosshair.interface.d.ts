...
export interface CategoryAxisCrosshair {
    ...
    width?: number;
    /**
     * The options of the crosshair tooltip. The crosshair tooltip is displayed when the [`categoryAxis.crosshair.tooltip.visible`](components/charts/api/chartcategoryaxiscrosshairtooltipprops#toc-visible) option is set to `true`.
     */
