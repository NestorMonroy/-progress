...
export interface CategoryAxisNotesLabel {
    ...
    font?: string;
    /**
     * The format for displaying the notes label. Uses the [`format`](components/intl/api/intlservice#toc-format) method of IntlService. Contains one placeholder (`"{0}"`) which represents the category value.
     */
    format?: string;
    /**
