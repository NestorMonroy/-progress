...
export interface SeriesLabels {
    /**
     * The alignment of the label when [`series.type`](components/charts/api/chartseriesitemprops#toc-type) is set to `"donut"`, `"funnel"`, `"pyramid"` or `"pie"`.
     *
    ...
    /**
     * The distance between the labels when [`series.type`](components/charts/api/chartseriesitemprops#toc-type) is set to `"donut"` or `"pie"`.
     */
    distance?: number;
    /**
    ...
    font?: string;
    /**
     * The format of the labels. Uses the [`format`](components/intl/api/intlservice#toc-format) method of IntlService.
     */
    format?: string;
    /**
    ...
    /**
     * The `from` label configuration of the Chart series. The Chart displays the series from labels when either the [`series.labels.visible`](components/charts/api/chartserieslabelsprops#toc-visible) or the [`series.labels.from.visible`](components/charts/api/chartseriesdefaultslabelsfromprops#toc-visible) option is set to `true`.
     */
    from?: SeriesLabelsFrom;
    /**
     * The `to` label configuration of the Chart series. The Chart displays the series to labels when either the [`series.labels.visible`](components/charts/api/chartserieslabelsprops#toc-visible) or the [`series.labels.to.visible`](components/charts/api/chartserieslabelstoprops#toc-visible) option is set to `true`.
     */
    to?: SeriesLabelsTo;
    /**
