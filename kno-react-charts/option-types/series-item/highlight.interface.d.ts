...
export interface SeriesHighlight {
     ...
     *
     * The color is computed automatically from the base point color. The border option is supported when [`series.type`](components/charts/api/chartseriesitemprops#toc-type) is set to `"donut"`, `"bubble"`, `"pie"`, `"candlestick"`, or `"ohlc"`.
     */
    border?: Border;
    /**
     * The highlight color. Accepts a valid CSS color string, including hex and rgb. The color option is supported when [`series.type`](components/charts/api/chartseriesitemprops#toc-type) is set to `"donut"` or `"pie"`.
     */
    color?: string;
    /**
     * The line of the highlighted Chart series. The color is computed automatically from the base point color. The line option is supported when [`series.type`](components/charts/api/chartseriesitemprops#toc-type) is set to `"candlestick"` or `"ohlc"`.
     */
    line?: HighlightLine;
    /**
     * The opacity of the highlighted points. The opacity option is supported when [`series.type`](components/charts/api/chartseriesitemprops#toc-type) is set to `"bubble"`, `"pie"`, or `"donut"`.
     */
    opacity?: number;
    /**
