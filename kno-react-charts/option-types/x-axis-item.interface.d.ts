...
export interface XAxis {
    ...
    /**
     * The interval between major divisions. If this is a date axis, the value represents the number of [`xAxis.baseUnits`](components/charts/api/chartxaxisitemprops#toc-baseunit) between major divisions. If [`xAxis.type`](components/charts/api/chartxaxisitemprops#toc-type) is set to `"log"`, the `majorUnit` value is used for the base of the logarithm.
     */
    majorUnit?: number;
    /**
    ...
    /**
     * The interval between minor divisions. It defaults to 1/5 of the [`xAxis.majorUnit`](components/charts/api/chartxaxisitemprops#toc-majorunit). If [`xAxis.type`](components/charts/api/chartxaxisitemprops#toc-type) is set to `"log"`, the `minorUnit` value represents the number of divisions between two major units and defaults to the major unit minus one.
     */
    minorUnit?: number;
    /**
     * The unique axis name. Used to associate a series with a X axis by using the [`series.xAxis`](components/charts/api/chartseriesitemprops#toc-xaxis) option.
     */
    name?: string;
    /**
    ...
    visible?: boolean;
    /**
     * The configuration options of the crosshair. The crosshair is displayed when the [`xAxis.crosshair.visible`](components/charts/api/chartxaxiscrosshairprops#toc-visible) option is set to `true`.
     */
    ...
    notes?: XAxisNotes;
    /**
     * The title configuration of the Scatter Chart X axis. To display the title, set the [`xAxis.title.text`](components/charts/api/chartxaxistitleprops#toc-text) option.
     */
    title?: XAxisTitle;
}
