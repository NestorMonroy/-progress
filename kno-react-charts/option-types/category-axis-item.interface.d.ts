...
export interface CategoryAxis {
    ...
    background?: string;
    /**
     * The base time interval for the date axis ([see example](components/charts/chart/elements/axes#toc-selecting-time-intervals)). The default base unit is automatically determined by the minimum difference between subsequent categories.
     *
     ...
     * - `"years"`
     *
     * Setting `baseUnit` to `"fit"` sets such a base unit and [`categoryAxis.baseUnitStep`](components/charts/api/chartcategoryaxisitemprops#toc-baseunitstep) that the total number of categories does not exceed [`categoryAxis.maxDateGroups`](components/charts/api/chartcategoryaxisitemprops#toc-maxdategroups).
     *
     * Series data is aggregated for the specified base unit by using the [`series.aggregate`](components/charts/api/chartseriesitemprops#toc-aggregate) function.
     */
    baseUnit?: CategoryBaseUnit;
    /**
     * The step (interval) between the categories in base units ([see example](components/charts/chart/elements/axes#toc-selecting-time-intervals)). Setting it to `"auto"` sets the step to such a value that the total number of categories does not exceed [`categoryAxis.maxDateGroups`](components/charts/api/chartcategoryaxisitemprops#toc-maxdategroups). The option is ignored if [`categoryAxis.baseUnit`](components/charts/api/chartcategoryaxisitemprops#toc-baseunit) is set to `"fit"`.
     */
    ...
    categories?: any[];
    /**
     * The color to apply to all axis elements. Accepts a valid CSS color string, including hex and rgb. Can be overridden by [`categoryAxis.labels.color`](components/charts/api/chartcategoryaxislabelsprops#toc-color) and [`categoryAxis.line.color`](components/charts/api/axisline#toc-color).
     */
    color?: string;
    /**
     * If set to `true`, the Chart positions categories and series points on major ticks. This removes the empty space before and after the series. The default value is `false` except for `"area"`, `"verticalArea"`, `"rangeArea"`, and `"verticalRangeArea"`. The option is ignored if the [`series.type`](components/charts/api/chartseriesitemprops#toc-type) option is set to `"bar"`, `"column"`, `"boxPlot"`, `"ohlc"`, `"candlestick"`, or `"waterfall"`.
     */
    justified?: boolean;
    /**
    ...
    /**
     * The last date displayed on a date category axis or the index of the last category displayed on a category axis ([see example](components/charts/chart/styling#toc-limiting-the-displayed-range)). By default, the max value is the same as the last category. This is often used in combination with the [`categoryAxis.min`](components/charts/api/chartcategoryaxisitemprops#toc-min) and [`categoryAxis.roundToBaseUnit`](components/charts/api/chartcategoryaxisitemprops#toc-roundtobaseunit) options to set up a fixed date range.
     */
    max?: any;
    /**
     * The maximum number of groups (categories) to display when [`categoryAxis.baseUnit`](components/charts/api/chartcategoryaxisitemprops#toc-baseunit) is set to `"fit"` or [`categoryAxis.baseUnitStep`](components/charts/api/chartcategoryaxisitemprops#toc-baseunitstep) is set to `"auto"`([see example](components/charts/chart/elements/axes#toc-selecting-time-intervals)).
     */
    maxDateGroups?: number;
    /**
     * The maximum number of ticks and labels to display. Applicabable for date category axis ([see example](components/charts/chart/elements/axes#toc-limiting-the-number-of-labels)).
     */
    maxDivisions?: number;
    /**
     * The first date which is displayed on a date category axis or the index of the first category which is displayed on a category axis ([see example](components/charts/chart/styling#toc-limiting-the-displayed-range)). By default, the min value is the same as the first category. This is often used in combination with the [`categoryAxis.max`](components/charts/api/chartcategoryaxisitemprops#toc-max) and [`categoryAxis.roundToBaseUnit`](components/charts/api/chartcategoryaxisitemprops#toc-roundtobaseunit) options to set up a fixed date range.
     */
    min?: any;
    /**
    ...
    /**
     * The unique axis name. Used to associate a series with a category axis, which utilizes the [`series.categoryAxis`](components/charts/api/chartseriesitemprops#toc-categoryaxis) option.
     */
    name?: string;
    /**
    ...
    /**
     * The configuration options of the crosshair. The crosshair is displayed when the [`categoryAxis.crosshair.visible`](components/charts/api/chartcategoryaxiscrosshairprops#toc-visible) option is set to `true`.
     */
