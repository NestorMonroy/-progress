 ...
 *-------------------------------------------------------------------------------------------
 */
import { FocusHighlight } from '@progress/kno-charts';
...
export interface Legend {
    /**
     * The legend is horizontally aligned when [`legend.position`](components/charts/api/chartlegendprops#toc-position) is set to `"top"` or `"bottom"`. The legend is vertically aligned when [`legend.position`](components/charts/api/chartlegendprops#toc-position) is set to `"left"` or `"right"`.
     *
    ...
    border?: Border;
    /**
     * The height of the legend when [`legend.orientation`](components/charts/api/chartlegendprops#toc-orientation) is set to `"vertical"`.
     */
    height?: number;
    /**
     ...
     * - `"custom"`&mdash;The legend is positioned by using [`legend.offsetX`](components/charts/api/chartlegendprops#toc-offsetx) and [`legend.offsetY`](components/charts/api/chartlegendprops#toc-offsety).
     */
    ...
    reverse?: boolean;
    /**
     * If set to `true`, the Chart displays the legend ([see example](components/charts/chart/elements/legend#toc-hiding-the-legend)). By default, the Chart legend is visible.
     */
    visible?: boolean;
    /**
     * The legend width when the [`legend.orientation`](components/charts/api/chartlegendprops#toc-orientation) is set to `"horizontal"`.
     */
    width?: number;
    /**
