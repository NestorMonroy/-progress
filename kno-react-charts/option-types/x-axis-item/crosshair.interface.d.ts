...
export interface XAxisCrosshair {
    ...
    width?: number;
    /**
     * The options of the crosshair tooltip. The crosshair tooltip is displayed when the [`xAxis.crosshair.tooltip.visible`](components/charts/api/chartxaxiscrosshairtooltipprops#toc-visible) option is set to `true`.
     */
