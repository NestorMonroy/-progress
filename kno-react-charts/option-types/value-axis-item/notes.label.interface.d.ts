...
export interface ValueAxisNotesLabel {
    ...
    font?: string;
    /**
     * The format used to display the notes label. Uses the IntlService [`format`](components/intl/api/intlservice#toc-format) method. Contains one placeholder (`"{0}"`) which represents the axis value.
     */
    format?: string;
    /**
