...
export interface ValueAxisCrosshair {
    ...
    width?: number;
    /**
     * The options of the crosshair tooltip. The crosshair tooltip is displayed when the [`valueAxis.crosshair.tooltip.visible`](components/charts/api/chartvalueaxiscrosshairtooltipprops#toc-visible) option is set to `true`.
     */
