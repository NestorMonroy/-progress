...
export interface AxisDefaults {
    ...
    visible?: boolean;
    /**
     * The crosshair configuration options. The crosshair is displayed when the [`axisDefaults.crosshair.visible`](components/charts/api/chartaxisdefaultscrosshairprops#toc-visible) option is set to `true`.
     */
    ...
    /**
     * The title configuration of the axis. To display the title, set the [`axisDefaults.title.text`](components/charts/api/chartaxisdefaultstitleprops#toc-text) option.
     */
