...
export interface ValueAxis {
    ...
    /**
     * The interval between major divisions. If [`valueAxis.type`](components/charts/api/chartvalueaxisitemprops#toc-type) is set to `"log"`, the `majorUnit` value is used for the base of the logarithm.
     */
    majorUnit?: number;
    /**
    ...
    /**
     * The interval between minor divisions. It defaults to one-fifth (1/5) of the [`valueAxis.majorUnit`](components/charts/api/chartvalueaxisitemprops#toc-majorunit). If [`valueAxis.type`](components/charts/api/chartvalueaxisitemprops#toc-type) is set to `"log"`, the `minorUnit` value represents the number of divisions between two major units and defaults to the major unit minus one.
     */
    minorUnit?: number;
    /**
     * The unique axis name. Used to associate a series with a value axis by using the [`series.axis`](components/charts/api/chartseriesitemprops#toc-axis) option.
     */
    name?: string;
    /**
     ...
     *
     * The crosshair is displayed when the [`valueAxis.crosshair.visible`](components/charts/api/chartvalueaxiscrosshairprops#toc-visible) option is set to `true`.
     */
     ...
     *
     * To display the title, set the [`valueAxis.title.text`](components/charts/api/chartvalueaxistitleprops#toc-text) option.
     */
