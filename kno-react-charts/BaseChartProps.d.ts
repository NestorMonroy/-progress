...
export interface BaseChartProps {
    ...
    children?: any;
    /**
     * Gets or sets the current drill-down state for [Drilldown Charts](components/charts/drill-down).
     *
    ...
    /**
     * Sets the preferred rendering engine ([see example](components/charts/chart/rendering)). If not supported by the browser, the Chart switches to the first available mode.
     *
    ...
    renderAs?: 'svg' | 'canvas';
    /**
     * Specifies if the Chart can be panned ([see example](components/charts/chart/pan-zoom)).
     */
    pannable?: boolean | DragAction;
    /**
     * Specifies if the Chart can be zoomed ([see example](components/charts/chart/pan-zoom)). Currently is only applicable to linear types, where the range on the X axis can be changed based on the zoom level.
     */
    ...
    /**
     * Fires when the user clicks a legend item ([see example](components/charts/chart/elements/legend#toc-clicking-legend-items)).
     */
    ...
    /**
     * Fires when the user hovers the plot area ([see example](components/charts/chart/elements/crosshairs#toc-current-cursor-values)).
     */
    onPlotAreaHover?: (event: PlotAreaHoverEvent) => void;
    /**
     * Fires when the Chart is ready to render on screen ([see example](components/charts/chart/elements/plot-bands#toc-custom-plot-bands)). For example, you can use it to remove loading indicators. Any changes made to the options are ignored.
     */
    onRender?: (event: RenderEvent) => void;
    /**
     * Fires when the Chart is about to refresh. The event can be used to prevent the refresh of the Chart in specific cases ([see example](components/charts/chart/chart-refresh).
     */
    ...
    /**
     * Fires when the user completes the modification of the selection ([see example](components/charts/chart/elements/selection#toc-using-selection-as-navigator)).
     *
     * The range units are:
     * - Generic axis&mdash;Category index (0-based).
     * - Date axis&mdash;Date instance.
