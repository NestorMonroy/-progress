...
const directionsMap = {
    up: {
        ...
        iconClass: "k-i-chevron-up"
    },
    down: {
        className: "k-navigator-s",
        iconClass: "k-i-chevron-down"
    },
    right: {
        className: "k-navigator-e",
        iconClass: "k-i-chevron-right"
    },
    left: {
        className: "k-navigator-w",
        iconClass: "k-i-chevron-left"
    }
};
...
function createButton(direction, iconOptions) {
    const html =
        '<button type="button" class="k-button k-button-square k-rounded-full k-button-flat k-icon-button ' +
            ...
            renderIcon({ icon: `chevron-${direction}`, iconClass: "k-button-icon", svgIcons: iconOptions.svgIcons, type: iconOptions.type }) +
        '</button>';
...
export class Navigator extends Observable {
    ...
    // originates from the kno.jquery version
    dispose() {
