import { drawing as draw, throttle, geometry } from '@progress/kno-drawing';
...
const frameworkElement = el => /^kno-/i.test(el.nodeName) || el.nodeType === 8;
...
class Chart {
    ...
    _setComputedStyles() {
        ...
        this.element.style.setProperty('--kno-chart-computed-title-height', `${titleHeight}px`);
    }
