...
import { validatePackage as u, getLicenseMessage as f, WatermarkOverlay as y } from "@progress/kno-react-common";
...
const i = class i extends r.Component {
  ...
  getGrid() {
    return r.Children.toArray(this.props.children).find(
      (t) => t && t.type.displayName === "knoReactGrid"
    );
  }
  getCustomColumns() {
    return r.Children.toArray(this.props.children).filter(
      (t) => t && t.type.displayName === "knoReactGridColumn"
    );
  }
  ...
  getGridNotColumnChildren(t) {
    return r.Children.toArray(t.props.children).filter(
      (s) => s && s.type && s.type.displayName !== "knoReactGridColumn"
    );
  }
};
i.propTypes = {
