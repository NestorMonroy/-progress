...
"use client";
import e from "react";
import { ActionSheet as p, ActionSheetView as v, ActionSheetHeader as h, ActionSheetContent as E, ActionSheetFooter as k } from "@progress/kno-react-layout";
import { useAdaptiveModeContext as F } from "@progress/kno-react-common";
import { GridContext as R } from "../../utils/GridContext.mjs";
import { Button as l } from "@progress/kno-react-buttons";
import { chevronRightIcon as G, chevronLeftIcon as B, xIcon as C, filterClearIcon as P } from "@progress/kno-svg-icons";
...
const te = (t) => {
  const n = e.useContext(R), { actionSheetRef: c, firstViewRef: I, secondViewRef: b } = e.useContext(L), o = F(), i = V(), [s, w] = e.useState(""), y = n.dir === "rtl" ? G : B, u = i.toLanguageString(
    ...
    t.onBackView && t.onBackView(), n != null && n.mobileMode && c.current.element.style.setProperty("--kno-actionsheet-view-current", 1);
  };
      ...
      /* @__PURE__ */ e.createElement(E, null, /* @__PURE__ */ e.createElement("div", { className: "k-column-menu k-column-menu-lg" }, t.filtered.map((a) => {
        ...
        return /* @__PURE__ */ e.createElement(T, { key: a.id }, /* @__PURE__ */ e.createElement("div", { className: "k-expander" }, /* @__PURE__ */ e.createElement(
          z,
          {
            ...
            onClick: (m) => (c.current.element.style.setProperty("--kno-actionsheet-view-current", 2), w(a.field), t.onFilterExpand(m, a))
          }
        )));
      }))),
