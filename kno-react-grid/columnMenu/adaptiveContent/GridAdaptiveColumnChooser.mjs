...
import { chevronRightIcon as A, chevronLeftIcon as y, xIcon as I, searchIcon as w } from "@progress/kno-svg-icons";
...
import { TextBox as L, Checkbox as g, InputPrefix as R } from "@progress/kno-react-inputs";
import { ActionSheetHeader as p, ActionSheetContent as F, ActionSheetFooter as P } from "@progress/kno-react-layout";
...
const Y = (t) => {
  ...
  e.useEffect(() => {
    l.mobileMode && c.current.element.style.setProperty("--kno-actionsheet-view-current", 2);
  }, []);
  const S = () => {
    l.mobileMode && c.current.element.style.setProperty("--kno-actionsheet-view-current", 1), t.onBackView && t.onBackView();
