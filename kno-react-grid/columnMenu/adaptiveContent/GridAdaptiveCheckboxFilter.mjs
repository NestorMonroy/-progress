...
import { ActionSheetHeader as x, ActionSheetContent as M, ActionSheetFooter as N } from "@progress/kno-react-layout";
import { Button as h } from "@progress/kno-react-buttons";
import { chevronRightIcon as A, chevronLeftIcon as w, xIcon as B } from "@progress/kno-svg-icons";
import { useLocalization as y } from "@progress/kno-react-intl";
import { Checkbox as d } from "@progress/kno-react-inputs";
...
const H = (t) => {
  ...
  e.useEffect(() => {
    n != null && n.mobileMode && o.current.element.style.setProperty("--kno-actionsheet-view-current", 2);
  }, []);
  const E = () => {
    t.onBackView && t.onBackView(), n != null && n.mobileMode && o.current.element.style.setProperty("--kno-actionsheet-view-current", 1);
  };
