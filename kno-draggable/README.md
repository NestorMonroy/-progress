...
The Kno UI Draggable component handles mouse drags and touch sequences on mobile devices.
...
The library is published as a [scoped NPM package](https://docs.npmjs.com/misc/scope) in the [NPMJS Telerik account](https://www.npmjs.com/~tlk).

```bash
npm install --save '@progress/kno-draggable';
```
...
```javascript
import Draggable from '@progress/kno-draggable';
