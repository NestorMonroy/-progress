...
// date packing utilities from Kno Spreadsheet
...
var Workbook = function Workbook(options) {
  ...
  Workbook.prototype.toZIP = function toZIP () {
      ...
      docProps.file("core.xml", CORE({
          creator: this.options.creator || "Kno UI",
          lastModifiedBy: this.options.creator || "Kno UI",
...
function fillCells(data, ctx) {
    ...
    for (var i = 0; i < cells.length; i++) {
        ...
        if (rowSpan === 1 && colSpan === 1) {
            ...
            // https://github.com/tlk/kno-ui-core/issues/2401
