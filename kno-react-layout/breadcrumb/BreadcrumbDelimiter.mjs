...
import { IconWrap as c } from "@progress/kno-react-common";
import { chevronLeftIcon as o, chevronRightIcon as d } from "@progress/kno-svg-icons";
...
m.displayName = "knoReactBreadcrumbDelimiter";
m.propTypes = s;
export {
