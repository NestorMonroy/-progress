...
/**
 * Represents the properties of [BreadcrumbLink](components/layout/api/breadcrumblink) component.
 */
 ...
 * @example
 * ```jsx
 * import { Breadcrumb, BreadcrumbLink } from '@progress/kno-react-layout';
 * const items = [
 *   {
 *     id: 'home',
 *     text: 'Home',
