...
const o = (t) => {
  ...
  return !d && t.children && t.children.length && (d = t.children.reduce((n, i) => o(i) + n, 0)), d;
};
function I(t, d) {
  const n = [[]];
  let i = 0;
...
function w(t, d, n = 0) {
  ...
  t.forEach((r) => {
    ...
    i.push(
      Object.assign({}, { depth: n }, g, r, {
        id: r.id ? r.id : p(`${d.prevId++}`, d.idPrefix, "column"),
...
function k(t, d) {
  ...
  let i = d.ownerDocument && Number.isFinite(n.x) && Number.isFinite(n.y) ? d.ownerDocument.elementFromPoint(n.x, n.y) : null;
