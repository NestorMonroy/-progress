...
import { Checkbox as h, NumericTextBox as E, Input as b } from "@progress/kendo-react-inputs";
...
const p = (n) => {
  ...
  const t = e.useCallback((r) => /* @__PURE__ */ e.createElement(b, { ...r, value: r.value || "" }), []), a = e.useRef(s.text), o = e.useRef({ operator: "", value: "" });
  return /* @__PURE__ */ e.createElement(
    p,
    {
  ...
  const t = e.useCallback((r) => /* @__PURE__ */ e.createElement(E, { ...r, value: r.value || null }), []), a = e.useRef(s.numeric), o = e.useRef({ operator: "", value: null });
  return /* @__PURE__ */ e.createElement(
    p,
    {
      initialFilter: o.current,
