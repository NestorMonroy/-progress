...
(function (DRAG_AND_DROP_DISPATCH_ACTION) {
    ...
    DRAG_AND_DROP_DISPATCH_ACTION["START"] = "kno_DRAG_AND_DROP_START";
    DRAG_AND_DROP_DISPATCH_ACTION["MOVE"] = "kno_DRAG_AND_DROP_MOVE";
    DRAG_AND_DROP_DISPATCH_ACTION["END"] = "kno_DRAG_AND_DROP_END";
    DRAG_AND_DROP_DISPATCH_ACTION["CANCEL"] = "kno_DRAG_AND_DROP_CANCEL";
            ...
            if (state.pressed) {
                if (state.autoScroll && event.originalEvent.type !== 'scroll') {
                    if (element) {
                        ...
                        var newVelocity = utils_1.autoScrollVelocity(event.clientX, event.clientY, utils_1.scrollableViewPort(scrollableParent_2, utils_1.getWindow(element)));
                        onVelocityChange({
