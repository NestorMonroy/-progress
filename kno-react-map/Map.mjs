...
import { InstanceObserver as l, Map as b } from "@progress/kno-charts";
...
import { validatePackage as k, getLicenseMessage as w, IconsContext as S, WatermarkOverlay as D } from "@progress/kno-react-common";
import { packageMetadata as u } from "./package-metadata.mjs";
import { toDomEvent as x } from "./events/dom-event.mjs";
import { chevronRightIcon as P, chevronLeftIcon as E, chevronDownIcon as U, chevronUpIcon as C, minusIcon as R, plusIcon as z, mapMarkerIcon as V, mapMarkerTargetIcon as W } from "@progress/kno-svg-icons";
const v = {
  mapMarkerTargetIcon: W,
  mapMarkerIcon: V,
  plusIcon: z,
  minusIcon: R,
  chevronUpIcon: C,
  ...
  constructor(e) {
    ...
    }, this.showLicenseWatermark = !k(u, { component: "Map" }), this.licenseMessage = w(u), this.optionsStore = m(M), this.observersStore = m(T), this.childrenObserver = new l(this, { onMouseLeave: "onChildMouseLeave" }), this.contextValue = {
   ...
   */
  render() {
    const { style: e = {}, className: t, children: s } = this.props, n = Object.assign({}, e, { position: "relative" }), r = a.createElement(
      "div",
      {
        className: t,
        style: n,
    ...
    return /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement(S.Consumer, null, (o) => /* @__PURE__ */ a.createElement(L.Provider, { value: this.contextValue }, /* @__PURE__ */ a.createElement(O, { key: "tooltip" }), r, this.setIcons(o))), this.showLicenseWatermark && /* @__PURE__ */ a.createElement(D, { message: this.licenseMessage }));
  }
  /**
   * @hidden
   */
  getMapOptions() {
    const { center: e, controls: t, minZoom: s, maxZoom: n, minSize: r, pannable: o, wraparound: i, zoom: c, zoomable: d } = this.props;
    let h = {
      center: e,
      controls: t,
      minZoom: s,
    ...
    return h = Object.assign(h, this.optionsStore.getState()), h;
  }
  /**
   ...
   */
  trigger(e, t) {
    const s = e === "click" ? "mapClick" : e, n = y(s, t, this), r = "on" + s.charAt(0).toUpperCase() + s.slice(1), o = this.observersStore.getState();
    let i = !1;
  ...
  setIcons(e) {
    const { type: t, icons: s = {} } = e, n = { ...v }, r = {
      mapMarkerTargetIcon: s.mapMarkerTargetIcon,
      mapMarkerIcon: s.mapMarkerIcon,
      plusIcon: s.plusIcon,
      minusIcon: s.minusIcon,
      chevronUpIcon: s.chevronUpIcon,
      chevronDownIcon: s.chevronDownIcon,
      chevronLeftIcon: s.chevronLeftIcon,
      chevronRightIcon: s.chevronRightIcon
    };
    let o;
    for (o in r)
      if (r[o]) {
