...
import { Window as g, WindowActionsBar as d } from "@progress/kno-react-dialogs";
import { Button as u } from "@progress/kno-react-buttons";
import { trimWhitespace as f, setHtml as w, indentHtml as v, getHtml as C } from "@progress/kno-editor-common";
import { provideLocalizationService as A, registerForLocalization as H } from "@progress/kno-react-intl";
import { messages as n } from "../messages/index.mjs";
import { editorPropsKey as x } from "../utils/props-key.mjs";
import { TextArea as z } from "@progress/kno-react-inputs";
