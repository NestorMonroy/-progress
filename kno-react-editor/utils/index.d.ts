 ...
 *-------------------------------------------------------------------------------------------
 */
import { ImageResizeOptions as ImageResizeOptionsCommon, Schema, NodeSpec, MarkSpec, Node, NodeType, Mark, MarkType, ParseOptions, EditorView, EditorState, Transaction, Plugin, PluginKey } from '@progress/kno-editor-common';
...
export declare namespace EditorUtils {
     ...
     * @example
     * ```jsx-no-run
     * import { EditorUtils } from '@progress/kno-react-editor';
     *
    ...
    /**
     * A function for sanitizing the content on paste ([see example](components/editor/paste)).
     *
     * @param {string} html&mdash;The input HTML.
    ...
    /**
     * A function for sanitizing the CSS classes of the pasted from MS Word content ([see example](components/editor/paste)).
    ...
    /**
     * A function for sanitizing the style attributes of the pasted from MS Word content ([see example](components/editor/paste)).
    ...
    /**
     * A function that will remove a DOM attribute from the pasted content ([see example](components/editor/paste)).
     *
