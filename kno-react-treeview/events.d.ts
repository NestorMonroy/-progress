...
/**
 * Represents the object of the `onExpandChange` event ([see example](components/treeview)).
 */
...
/**
 * Represents the object of the `onItemClick` event ([see example](components/treeview)).
 */
...
/**
 * Represents the object of the `onCheckChange` event ([see example](components/treeview/checkboxes/helper-functions)).
 */
...
/**
 * Represents the object of the `onContextMenu` event ([see example](components/treeview)).
 */
...
/**
 * Represents the object of the `onItemDragOver` event ([see example](components/treeview/drag-drop)).
 */
...
/**
 * Represents the object of the `onItemDragEnd` event ([see example](components/treeview/drag-drop)).
 */
