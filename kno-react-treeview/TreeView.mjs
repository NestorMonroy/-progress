...
import { treeIdUtils as u, validatePackage as g, getLicenseMessage as F, TreeFieldsService as E, classNames as b, kendoThemeMaps as C, WatermarkOverlay as v, Keys as d, hasChildren as D, dispatchEvent as p, resolveItemId as x, isEnabledAndAllParentsEnabled as k } from "@progress/kno-react-common";
...
const { sizeMap: O } = C, r = class r extends l.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ l.createElement(
      ...
      /* @__PURE__ */ l.createElement(
        ...
        this.data.map((i, s) => /* @__PURE__ */ l.createElement(
          w,
          {
  ...
  refocusDueToFocusIdField() {
    if (this.fieldsSvc && this.fieldsSvc.focusIdField) {
      ...
      if (t) {
        const e = this.props.getFocusHierarchicalIndex ? this.props.getFocusHierarchicalIndex(t) : x(
          t,
