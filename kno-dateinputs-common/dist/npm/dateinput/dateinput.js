...
var DateInput = /** @class */ (function (_super) {
    ...
    DateInput.prototype.init = function (element, options) {
        var dateValue = (0, utils_2.isValidDate)(this.options.value) ? (0, kno_date_math_1.cloneDate)(this.options.value) : new Date(options.formattedValue);
        if (!(0, utils_2.isValidDate)(dateValue)) {
            dateValue = null;
        }
        this.element = element;
        // this.element._knoWidget = this;
    ...
    DateInput.prototype.onElementInput = function (e) {
        ...
        var hasExistingDateValueChanged = !(0, kno_date_math_1.isEqual)(oldExistingDateValue, newExistingDateValue);
    ...
    DateInput.prototype.tryTriggerValueChange = function (args) {
        ...
        if (!(0, kno_date_math_1.isEqual)(this.value, args.oldValue)) {
