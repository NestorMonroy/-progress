[![knoReact NPM Banner](https://raw.githubusercontent.com/tlk/kno-react/master/images/knoreact-github-banner.png)](components/getting-started/free-vs-premium?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges&utm_content=banner)

# knoReact Gauges Library for React
...
-   [Getting Started with knoReact](components/getting-started/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [Get Started with ]
-   [Getting Started with the knoReact Gauges](components/gauges/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [API Reference of the knoReact gauges](components/gauges/api/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [knoReact Roadmap](/support/whats-new/kno-react-ui/roadmap?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [Blogs](/blogs/tag/knoreact?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [Demos, documentation, and component reference](components/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [knoReact pricing and licensing](pricing?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)
-   [Changelog](components/changelogs/ui-for-react/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-gauges)

High-level component overview pages

-   [React ArcGauge Component](arcgauge)
-   [React Circular Gauge Component](circulargauge)
-   [React LinearGauge Component](lineargauge)
-   [React RadialGauge Component](radialgauge)
