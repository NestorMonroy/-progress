 ...
 *-------------------------------------------------------------------------------------------
 */
"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const i=require("@progress/kno-licensing"),g=require("./canUseDOM.js"),d=["tlk.com","progress.com","stackblitz.io","csb.app"],h="components/getting-started/?utm_medium=product&utm_source=console&utm_campaign=dt_knoreact_freemium",n=new Map,k=()=>{const t=Array.from(n,([e,c])=>`- ${e}: ${Array.from(c).join(", ")||"all"}`).join(`
`);console.group("[WARN][Telerik and Kno UI Licensing] knoReact"),console.warn(`License check was triggered by these knoReact components/features
${t}
