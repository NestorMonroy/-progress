...
/**
 * Represents the props of the [knoReact Typography component](components/common/typography).
 */
export interface TypographyProps extends KendoReactComponentBaseProps {
     ...
     * [see example](components/common/typography/appearance#toc-font-size).
     *
     ...
     * [see example](components/common/typography/appearance#toc-font-weight).
     *
     * The possible values are:
     ...
     * [see example](components/common/typography/appearance#toc-margin).
     *
     ...
     * [see example](components/common/typography/appearance#toc-text-alignment).
     *
     * The possible values are:
     ...
     * [see example](components/common/typography/appearance#toc-text-transformation).
     *
     * The possible values are:
     ...
     * [see example](components/common/typography/appearance#toc-theme-color).
     *
     * The possible values are:
