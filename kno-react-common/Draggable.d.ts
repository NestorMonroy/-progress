...
/**
 * Represents the props of the knoReact Draggable component.
 */
...
/**
 * Represents the knoReact Draggable component.
 *
 * Accepts properties of type [DraggableProps](components/common/api/draggableprops),
 * and returns an object of type [DraggableHandle](components/common/api/draggablehandle) when the `ref` is obtained.
 */
