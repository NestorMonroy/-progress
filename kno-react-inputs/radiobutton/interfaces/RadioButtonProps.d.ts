...
/**
 * Represents the props of the [knoReact RadioButton component](components/inputs/radiobutton).
...
export interface RadioButtonProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size' | 'onChange' | 'onFocus' | 'onBlur'> {
    ...
    /**
     * Sets the label of the Radio button ([see example](components/inputs/radiobutton/labels)).
     */
    label?: string;
    /**
     * Sets the label position of the Radio button ([see example](components/inputs/radiobutton/labels)).
