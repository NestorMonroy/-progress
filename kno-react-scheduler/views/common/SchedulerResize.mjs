...
import { SchedulerItem as h } from "../../items/SchedulerItem.mjs";
import { SchedulerViewItem as g } from "../../items/SchedulerViewItem.mjs";
...
const V = (e) => {
  ...
  return v(a, f), /* @__PURE__ */ t.createElement(t.Fragment, null, a.map((m, I) => {
    var l;
