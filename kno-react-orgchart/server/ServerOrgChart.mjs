...
import { classNames as O, knoThemeMaps as b } from "@progress/kno-react-common";
  ...
  return /* @__PURE__ */ N.createElement("div", { className: "k-orgchart-container", style: { width: n, height: _ || D } }, E.map((o) => {
    ...
    return /* @__PURE__ */ N.createElement(
      "div",
      {
        ...
        key: o.ids[0] + "_" + W,
        className: O("k-orgchart-group", `k-orgchart-level-${W + 1}`, "k-pos-absolute", {
...
Z.displayName = "knoServerOrgChart";
export {
  Z as ServerOrgChart
};
