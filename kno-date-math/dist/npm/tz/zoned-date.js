...
function isZoneMissingHour(date, timezone) {
    var currentOffset = (0, offset_1.offset)(timezone, date);
    var prevHour = addHours(date, -1);
    var prevOffset = (0, offset_1.offset)(timezone, prevHour);
...
function convertTimezoneUTC(utcLocal, fromTimezone, toTimezone) {
    ...
    var fromOffset = (0, offset_1.offset)(fromTimezone, utcLocal);
    var toOffset = (0, offset_1.offset)(toTimezone, utcLocal);
    var baseDiff = fromOffset - toOffset;
    var midDate = addMinutes(utcLocal, baseDiff);
    var midOffset = (0, offset_1.offset)(toTimezone, midDate);
...
function formatOffset(tzOffset) {
    ...
    var hours = (0, pad_number_1.padNumber)(Math.floor(value / 60));
    var minutes = (0, pad_number_1.padNumber)(value % 60);
    return "GMT".concat(sign).concat(hours).concat(minutes);
}
// Duplicate from kno-recurrence
 ...
 * import '@progress/kno-date-math/tz/America/New_York';
 *
 ...
 * import { ZonedDate } from '@progress/kno-date-math';
 * import '@progress/kno-date-math/tz/America/New_York';
 * import '@progress/kno-date-math/tz/America/Los_Angeles';
 *
...
var ZonedDate = /** @class */ (function () {
    ...
    function ZonedDate(utcDate, timezone) {
        this._utcDate = (0, clone_date_1.cloneDate)(utcDate);
        this.timezone = timezone;
        if (timezone === '') {
            var localDate = (0, to_local_date_1.toLocalDate)(utcDate);
            this.timezoneOffset = localDate.getTimezoneOffset();
            this._localDate = localDate;
        }
        else {
            var tzOffset = (0, offset_1.offset)(timezone, utcDate);
    ...
    ZonedDate.prototype.toLocalDate = function () {
        return (0, clone_date_1.cloneDate)(this._localDate);
    };
    /**
    ...
    ZonedDate.prototype.toUTCDate = function () {
        return (0, clone_date_1.cloneDate)(this._utcDate);
    };
    /**
    ...
    ZonedDate.prototype.toTimezone = function (toTimezone) {
        ...
        var tzOffset = (0, offset_1.offset)(this.timezone, this._utcDate);
    ...
    ZonedDate.prototype.toDateString = function () {
        return (0, to_local_date_1.toLocalDate)(this._utcDate).toDateString();
    };
    /** @hidden */
    ZonedDate.prototype.toTimeString = function () {
        var hours = (0, pad_number_1.padNumber)(this.getHours());
        var minutes = (0, pad_number_1.padNumber)(this.getMinutes());
        var seconds = (0, pad_number_1.padNumber)(this.getSeconds());
        var time = "".concat(hours, ":").concat(minutes, ":").concat(seconds);
        var tzOffset = formatOffset(this.timezoneOffset);
        var abbrev = (0, abbr_timezone_1.abbrTimezone)(this.timezone, this._utcDate);
        if (abbrev) {
