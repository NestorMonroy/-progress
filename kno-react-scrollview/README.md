[![knoReact NPM Banner](https://raw.githubusercontent.com/tlk/kno-react/master/images/knoreact-github-banner.png)](components/getting-started/free-vs-premium?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview&utm_content=banner)

# knoReact ScrollView Component for React

> **Important**
>
> -   This package is а part of [knoReact](/kno-react-ui?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)&mdash;an enterprise-grade UI library with 120+ free and premium components.
...
> -   It provides a premium knoReact component. You will need to install a license key when adding the package to your project. For more information, please refer to the [knoReact My License page](?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview).
> -   To receive a license key, you need to either [purchase a license](pricing?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview) or register for a [free trial](/try/kno-react-ui?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview). Doing so indicates that you [accept the knoReact License Agreement](/purchase/license-agreement/progress-knoreact?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview).
...
>
> [Start using knoReact](/try/kno-react-ui?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview) and speed up your development process!
>
...
-   [Getting Started with knoReact](components/getting-started/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [Get Started with ]
-   [Get Started with the knoReact ScrollView](components/scrollview/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [API Reference of the knoReact ScrollView](components/scrollview/api/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [knoReact Roadmap](/support/whats-new/kno-react-ui/roadmap?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [Blogs](/blogs/tag/knoreact?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [Demos, documentation, and component reference](components/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [knoReact pricing and licensing](pricing?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)
-   [Changelog](components/changelogs/ui-for-react/?utm_medium=referral&utm_source=npm&utm_campaign=kno-ui-react-trial-npm-scrollview)

High-level component overview pages

-   [React ScrollView (Carousel) Component](scrollview)
