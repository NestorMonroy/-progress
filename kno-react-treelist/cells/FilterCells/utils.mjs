...
function G(p, n) {
  return {
    clearButtonTitle: p.toLanguageString(i, l[i]),
    operators: n.map((t) => ({
      text: p.toLanguageString(t.text, l[t.text]),
      operator: t.operator
    }))
  };
}
