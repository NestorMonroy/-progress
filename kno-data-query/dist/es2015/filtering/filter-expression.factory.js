...
/**
 * Creates a [Predicate]({% slug api_kno-data-query_predicate %}) function for the specified [CompositeFilterDescriptor]({% slug api_kno-data-query_compositefilterdescriptor %}).
 *
 ...
 * @example
 * ```ts
 * import { compileFilter } from '@progress/kno-data-query';
 *
...
// tslint:disable:max-line-length
/**
 * Filters the provided array according to the specified [CompositeFilterDescriptor]({% slug api_kno-data-query_compositefilterdescriptor %}).
 *
 ...
 * @example
 * ```ts
 * import { filterBy } from '@progress/kno-data-query';
 *
 * const data = [
