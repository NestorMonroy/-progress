...
/**
 * Converts a [`FilterDescriptor`]({% slug api_kno-data-query_filterdescriptor %}) into a [`CompositeFilterDescriptor`]({% slug api_kno-data-query_compositefilterdescriptor %}). If a `CompositeFilterDescriptor` is passed, no modifications will be made.
 *
