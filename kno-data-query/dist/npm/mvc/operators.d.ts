...
/**
 * Represents the state required by the [`toDataSourceRequest`]({% slug api_kno-data-query_todatasourcerequest %})
 * and [`toDataSourceRequestString`]({% slug api_kno-data-query_todatasourcerequeststring %}) methods.
 *
 * The `DataSourceRequestState` is an extension of the [`State`]({% slug api_kno-data-query_state %}) type
 * with an additional `aggregates` field&mdash;an array of [`AggregateDescriptor`]({% slug api_kno-data-query_aggregatedescriptor %}).
 *
 ...
 * of the [`GroupDescriptor`]({% slug api_kno-data-query_groupdescriptor %}) used by the `group` field.
 *
 * ```ts
 * import { DataSourceRequestState } from '@progress/kno-data-query';
 *
...
/**
 * Converts a [`DataSourceRequestState`]({% slug api_kno-data-query_datasourcerequeststate %}) into a string
 ...
 * import { toDataSourceRequestString, translateDataSourceResultGroups } from '@progress/kno-data-query';
 *
...
/**
 * Converts a [`DataSourceRequestState`]({% slug api_kno-data-query_datasourcerequeststate %}) into an object
