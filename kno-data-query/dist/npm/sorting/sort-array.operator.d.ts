 ...
 *
 * For more information, refer to the [`composeSortDescriptors`]({% slug api_kno-data-query_composesortdescriptors %}) configuration.
 *
 * @example
 * ```ts
...
/**
 * Converts the `SortDescriptors` into a [Comparer]({% slug api_kno-data-query_comparer %}) function that can be used through `Array.sort`. If multiple descriptors are provided, sorting is applied in a right-to-left order.
 * @param {SortDescriptor[]} descriptors - The descriptors which will be converted.
 * @returns {Comparer} - The produced function.
 *
 * @example
 * ```ts
 * import { composeSortDescriptors } from '@progress/kno-data-query';
 *
