...
/**
 * The group descriptor used by the [`groupBy`](slug:api_kno-data-query_groupby) method.
 * @example
 * ```ts
...
export interface GroupResult {
    ...
    items: Object[];
    /**
     * The aggregated values for the group. An [AggregateResult]({% slug api_kno-data-query_aggregateresult %}) instance.
     */
