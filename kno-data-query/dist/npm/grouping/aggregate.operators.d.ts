 ...
 *
 * For more information, refer to the [`aggregateBy`]({% slug api_kno-data-query_aggregateby %}) method.
 */
...
/**
 * Applies the specified [`AggregateDescriptors`]({% slug api_kno-data-query_aggregatedescriptor %}) to the data. Returns an [`AggregateResult`]({% slug api_kno-data-query_aggregateresult %}) instance.
 *
 * @example
 * ```ts
 * const data = [
