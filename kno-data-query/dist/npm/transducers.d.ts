...
/**
 * The result of the [aggregate operation]({% slug api_kno-data-query_aggregateby %}) where the keys are the field name used for the calculation and the values are an object with the aggregate function name and a resulting value.
 *
 * @example
 * ```js
