...
/**
 * Represents the properties of the [MultiColumnComboBox](components/dropdowns/api/multicolumncombobox) component.
 */
 ...
 *
 * Accepts properties of type [MultiColumnComboBoxProps](components/dropdowns/api/multicolumncomboboxprops).
 * Obtaining the `ref` returns an object of type [MultiColumnComboBoxHandle](components/dropdowns/api/multicolumncomboboxhandle).
 *
 * @example
 * ```jsx
 * const columns = [
