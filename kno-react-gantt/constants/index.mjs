...
import { TABLE_COL_INDEX_ATTRIBUTE as T, TABLE_PREVENT_SELECTION_ELEMENT as _, TABLE_ROW_INDEX_ATTRIBUTE as t } from "@progress/kendo-react-data-tools";
const n = t, N = T, o = _, s = (/* @__PURE__ */ new Date()).getTime(), I = 7, d = "hh:mm a", R = { skeleton: "MEd" }, c = "MMM", i = "yyyy", L = 100, O = 6, E = "data-dependency-drag-handle", A = "start", D = "finish", M = { [E]: A }, S = { [E]: D }, r = "data-task-id", a = {
  id: "id",
  start: "start",
  end: "end",
  title: "title",
