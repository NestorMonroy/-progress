...
import { GanttYearView as Ke, ganttYearViewDefaultProps as We } from "./views/GanttYearView.mjs";
import { flatData as Le } from "@progress/kendo-react-treelist";
import { validatePackage as Be, getLicenseMessage as Oe, getter as h, useIsomorphicLayoutEffect as Ye, useWebMcpRegister as je, classNames as Ue, WatermarkOverlay as _e } from "@progress/kendo-react-common";
import { useControlledState as qe } from "./hooks/useControlledState.mjs";
...
import { Toolbar as Xe } from "./components/toolbar/Toolbar.mjs";
import { ToolbarSpacer as Ze } from "@progress/kendo-react-buttons";
import { DEFAULT_DATE as I } from "./constants/index.mjs";
import { packageMetadata as H } from "./package-metadata.mjs";
import { AddButton as $e } from "./components/toolbar/AddButton.mjs";
const z = a.forwardRef((e, A) => {
  ...
  d.set(Ae, Ge), d.set(Ne, Pe), d.set(M, ze), d.set(Ke, We);
  const p = Ie(), { fields: o } = a.useMemo(
    ...
    [o.start, o.end]
  ), m = a.useMemo(() => (c.current = null, i.current = null, g.current = null, Le(v, E, ne)), [v, E]);
  ...
  ), te = a.cloneElement(/* @__PURE__ */ a.createElement(M, null), d.get(M)), x = f.length ? f[0] : te, [F, ae] = qe(
  ...
  a.useImperativeHandle(l, () => ({ props: e, element: V.current, scrollIntoView: ce })), a.useImperativeHandle(A, () => l.current), je("gantt", l, e, e.webMcp);
  ...
  return /* @__PURE__ */ a.createElement(
    ...
    /* @__PURE__ */ a.createElement("div", { ref: V, role: "application", style: W, className: Ue("k-gantt", L) }, /* @__PURE__ */ a.createElement(Xe, { ref: b }, T && T.addTaskButton ? /* @__PURE__ */ a.createElement($e, { selectedTask: g.current, onClick: ke }) : null, /* @__PURE__ */ a.createElement(Ze, null), /* @__PURE__ */ a.createElement(Qe, null, /* @__PURE__ */ a.createElement(Je, null))), s && /* @__PURE__ */ a.createElement(
      s.type,
      {
        key: s.props.name,
        ref: w,
    ...
    ), G && /* @__PURE__ */ a.createElement(_e, { message: N }))
  );
}), R = {
  taskData: [],
  dependencyData: [],
