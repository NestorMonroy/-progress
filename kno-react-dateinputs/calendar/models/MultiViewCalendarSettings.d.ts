...
export interface MultiViewCalendarSettings {
     ...
     * ([see example](components/dateinputs/multiviewcalendar/custom-rendering#toc-cells-inside-the-view)).
     */
     ...
     * ([see example](components/dateinputs/multiviewcalendar/custom-rendering#toc-cells-inside-the-week-column)).
     */
     ...
     * ([see example](components/dateinputs/multiviewcalendar/custom-rendering#toc-titles-of-current-views)).
     */
