...
export interface TimePickerSettings {
    ...
    nowButton?: boolean;
    /**
     * Sets the default state of the popup upon render ([see example](components/dateinputs/timepicker/default-value#toc-setting-the-default-popup-state)).
     */
    defaultShow?: boolean;
    /**
     * Determines whether the TimePicker is disabled ([see example](components/dateinputs/timepicker/disabled-state)).
     */
    disabled?: boolean;
    /**
     * Specifies the date format that is used to display the input value ([see example](components/dateinputs/timepicker/formats)).
     */
    format?: string | DateFormatOptions;
    /**
     * Defines the descriptions of the format sections in the input field ([see example](components/dateinputs/timepicker/placeholders)).
     */
    ...
    /**
     * Specifies the greatest valid time ([see example](components/dateinputs/timepicker/time-ranges)).
     */
    max?: Date;
    /**
     * Specifies the smallest valid time ([see example](components/dateinputs/timepicker/time-ranges)).
     */
    min?: Date;
    /**
    ...
    /**
     * Specifies if a time selector will be displayed ([see example](components/dateinputs/timepicker/controlled-state#toc-controlling-the-popup-state)).
     */
    show?: boolean;
    /**
     * Configures the incremental steps of the TimePicker ([see example](components/dateinputs/timepicker/incremental-steps)).
     *
     ...
     * ([see example](components/dateinputs/timepicker/custom-rendering#toc-customizing-the-popup)).
     */
    popup?: React.ComponentType<PopupProps>;
    /**
     * Enables the customization or the override of the default DateInput which is rendered by the TimePicker
     * ([see example](components/dateinputs/timepicker/custom-rendering#toc-customizing-the-dateinput)).
     */
     ...
     * [placeholders](components/dateinputs/timepicker/placeholders).
     */
