...
var kno_drawing_1 = require("@progress/kno-drawing");
var common_1 = require("../common");
var Point = kno_drawing_1.geometry.Point, Rect = kno_drawing_1.geometry.Rect, transform = kno_drawing_1.geometry.transform;
var noop = function () { };
...
var SignaturePad = /** @class */ (function () {
    ...
    Object.defineProperty(SignaturePad.prototype, "pathData", {
        ...
        set: function (value) {
            this.clear();
            this.path = kno_drawing_1.MultiPath.parse(value, this.pathOptions);
    ...
    SignaturePad.prototype.loadImage = function (data, size) {
        ...
        var img = new kno_drawing_1.Image(data, new kno_drawing_1.geometry.Rect([0, 0], [importWidth, importHeight]));
    ...
    SignaturePad.prototype.exportImage = function (options) {
        ...
        var exportGroup = new kno_drawing_1.Group({
            clip: kno_drawing_1.Path.fromRect(exportRect)
        });
        var contentGroup = new kno_drawing_1.Group({
            transform: transform().scale(scale, scale)
        });
        var frame = kno_drawing_1.Path.fromRect(exportRect, {
            fill: {
        ...
        return kno_drawing_1.exportImage(exportGroup, Object.assign({
            width: exportWidth,
            height: exportHeight
        }, options));
    };
    ...
    SignaturePad.prototype.initSurface = function () {
        this.surface = kno_drawing_1.Surface.create(this.element, { type: 'canvas' });
        this.element.style.touchAction = 'none';
        var scale = this.options.scale;
        this.rootGroup = new kno_drawing_1.Group({
            transform: transform().scale(scale, scale)
        });
        ...
        this.background = kno_drawing_1.Path.fromRect(new Rect([0, 0], this.size), {
            fill: {
                color: this.options.backgroundColor
            }
        });
    ...
    SignaturePad.prototype.onPointerDown = function (e) {
        ...
        if (!this.path) {
            this.path = new kno_drawing_1.MultiPath(this.pathOptions);
            this.rootGroup.append(this.path);
        }
        this.options.onDraw();
    ...
    SignaturePad.prototype.onPointerUp = function (e) {
        ...
        if (this.options.smooth) {
            var segments = kno_drawing_1.Path.curveFromPoints(this.points);
