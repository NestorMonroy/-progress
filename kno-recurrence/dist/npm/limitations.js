...
exports.bySecond = exports.byMinute = exports.byHour = exports.byWeekDay = exports.byWeekNumber = exports.byYearDay = exports.byMonthDay = exports.byMonth = void 0;
...
var weekInMonth = function (date, weekStart) {
    var firstWeekDay = (0, utils_1.toUTCDateTime)((0, kno_date_math_1.firstDayOfMonth)(date)).getUTCDay();
...
var weekInYear = function (date, weekStart) {
    ...
    if (weekStart !== undefined) {
        (0, utils_1.setDayOfWeek)(date, weekStart, -1);
...
var normalizeOffset = function (date, rule, weekStart) {
    ...
    var day = (0, utils_1.normalizeDayIndex)(rule.day, weekStart);
    var skipFirst = day < (0, utils_1.normalizeDayIndex)(new Date(Date.UTC(date.getUTCFullYear(), date.getUTCMonth(), 1)).getUTCDay(), weekStart);
    var skipLast = day > (0, utils_1.normalizeDayIndex)(lastDate.getUTCDay(), weekStart);
    if (offset < 0) {
...
var ruleWeekValues = function (days, date, weekStart) {
    var currentDay = (0, utils_1.normalizeDayIndex)(date.getUTCDay(), weekStart);
    ...
    for (var idx = 0; idx < length; idx++) {
        ...
        if (weekNumber < ruleWeekOffset) {
            ...
            day = (0, utils_1.normalizeDayIndex)(weekDay.day, weekStart);
            if (currentDay < day) {
                result.push(weekDay);
            }
...
/** @hidden */
var byMonth = function (date, _end, rule) {
...
exports.byYearDay = byYearDay;
/** @hidden */
var byWeekNumber = function (date, end, rule) {
    var weekStart = rule.weekStart || kno_date_math_1.Day.Monday;
    var changed = false;
...
exports.byWeekNumber = byWeekNumber;
/** @hidden */
var byWeekDay = function (startDate, end, rule) {
    ...
    if (!weekDayRules[0]) {
        ...
        (0, utils_1.setDayOfWeek)(startDate, weekStart);
    }
    var results = weekDayRules.map(function (weekDayRule) {
        var date = (0, kno_date_math_1.cloneDate)(startDate);
        ...
        if (date.getUTCDay() !== day) {
            (0, utils_1.setDayOfWeek)(date, day);
        }
        return date;
...
exports.byWeekDay = byWeekDay;
/** @hidden */
var byHour = function (date, _end, rule) {
...
exports.byHour = byHour;
/** @hidden */
var byMinute = function (date, _end, rule) {
