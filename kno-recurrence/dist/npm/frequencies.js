...
exports.YearlyFrequency = exports.MonthlyFrequency = exports.WeeklyFrequency = exports.DailyFrequency = exports.HourlyFrequency = exports.BaseFrequency = void 0;
...
var BaseFrequency = /** @class */ (function () {
    ...
    BaseFrequency.prototype.interval = function (rule, current) {
        ...
        if (frequency === 'hourly') {
            ...
            if (hours !== startTimeHours) {
                date += (startTimeHours - hours) * kno_date_math_1.MS_PER_HOUR;
            }
            date -= start.getTime();
            diff = Math.floor(date / kno_date_math_1.MS_PER_HOUR);
            ...
            addTime(date, -start.getTime());
            diff = Math.round(date / kno_date_math_1.MS_PER_DAY);
            excess = intervalExcess(diff, interval);
            if (excess !== 0) {
            ...
            var normalizedCurrentIndex = (0, utils_1.normalizeDayIndex)(current.getUTCDay(), weekStart);
            var normalizedStartIndex = (0, utils_1.normalizeDayIndex)(start.getUTCDay(), weekStart);
            if (normalizedCurrentIndex < normalizedStartIndex) {
                excess += 1;
            }
            excess = intervalExcess(excess, interval);
            if (excess !== 0) {
                (0, utils_1.setDayOfWeek)(current, rule.weekStart, -1);
            ...
            excess = intervalExcess(diff, interval);
            if (excess !== 0) {
                day = (0, utils_1.hasModifiers)(rule) ? 1 : current.getDate();
    ...
    BaseFrequency.prototype._date = function (date, _rule, interval) {
