...
import { MS_PER_DAY, MS_PER_HOUR } from '@progress/kno-date-math';
...
var HourlyFrequency = /** @class */ (function (_super) {
    __extends(HourlyFrequency, _super);
...
var DailyFrequency = /** @class */ (function (_super) {
    __extends(DailyFrequency, _super);
...
var WeeklyFrequency = /** @class */ (function (_super) {
    __extends(WeeklyFrequency, _super);
...
var MonthlyFrequency = /** @class */ (function (_super) {
    __extends(MonthlyFrequency, _super);
...
var YearlyFrequency = /** @class */ (function (_super) {
    __extends(YearlyFrequency, _super);
